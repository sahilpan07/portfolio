      ...
      <div className="flex  justify-center flex-col w-4/5 h-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2  gap-12">
          ...
          <div className="z-10 max-w-xl space-y-6 text-center md:text-left">
            ...
            <h1 className="pb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent">
              {BaseInfo.position}
            </h1>
